...
void PointLight::sendShadowDataToShader(const Shader& shaderProgram, unsigned lightIndex) const
{
	...
	shaderProgram.setVec3("lightPosition", transform.position);
...
void PointLight::update(float deltaTime)
{
	...
	shadowMatrices[0] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f));
	shadowMatrices[1] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(-1.0f, 0.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f)); //the wrong one
	shadowMatrices[2] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f)); //top
	shadowMatrices[3] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(0.0f, -1.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f));//bottom
	shadowMatrices[4] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.0f, -1.0f, 0.0f));//not
	shadowMatrices[5] = shadowProj * glm::lookAt(transform.position, transform.position + glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, -1.0f, 0.0f));//not
}
