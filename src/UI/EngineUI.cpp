...
void EngineUI::renderUI()
{
    ...
    ImGui::NewFrame();
    //Gizmo library needs a begin frame too
    ImGuizmo::BeginFrame();

    //BORROWING SOME CODE FOR THE DOCKING LOGIC FROM THE CHERNO'S HAZEL ENGINE UNTIL I GET FULL UNDERSTANDING OF HOW IMGUI DOCKING WORKS
    //====================TEST CODE FROM HAZEL================
